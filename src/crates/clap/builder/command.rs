...
// Internal
use crate::crates::clap::builder::app_settings::{AppFlags, AppSettings};
use crate::crates::clap::builder::arg_settings::ArgSettings;
use crate::crates::clap::builder::ext::Extensions;
use crate::crates::clap::builder::ArgAction;
use crate::crates::clap::builder::IntoResettable;
...
use crate::crates::clap::builder::{Arg, ArgGroup, ArgPredicate};
use crate::crates::clap::clap_lex;
use crate::crates::clap::error::ErrorKind;
use crate::crates::clap::error::Result as ClapResult;
use crate::crates::clap::mkeymap;
use crate::crates::clap::mkeymap::MKeyMap;
use crate::crates::clap::output::fmt::Stream;
use crate::crates::clap::output::{fmt::Colorizer, write_help, Usage};
use crate::crates::clap::parser::{ArgMatcher, ArgMatches, Parser};
use crate::crates::clap::util::ChildGraph;
use crate::crates::clap::util::{color::ColorChoice, Id};
use crate::crates::clap::{Error, INTERNAL_ERROR_MSG};

#[cfg(debug_assertions)]
use crate::crates::clap::builder::debug_asserts::assert_app;
...
impl Command {
    ...
    /// Get the name of the binary.
    #[inline]
    pub fn get_bin_name_fallback(&self) -> &str {
        ...
        if !self.settings.is_set(AppSettings::Built) {
            ...
            #[allow(deprecated)]
            {
                let highest_idx = self
                    ...
                    .keys()
                    .filter_map(|x| {
                        if let mkeymap::KeyType::Position(n) = x {
                            Some(*n)
                        } else {
                            None
                        }
...
impl Command {
    ...
    #[inline]
    pub fn aliases_to(&self, name: impl AsRef<std::ffi::OsStr>) -> bool {
        let name = name.as_ref();
    ...
    #[inline]
    pub fn short_flag_aliases_to(&self, flag: char) -> bool {
    ...
    #[inline]
    pub fn long_flag_aliases_to(&self, flag: &str) -> bool {
    ...
    pub fn all_subcommand_names(&self) -> impl Iterator<Item = &str> + Captures {
...
pub trait AppTag: crate::crates::clap::builder::ext::Extension {}
