...
use crate::crates::clap::builder::ValueHint;
use crate::crates::clap::builder::ValueRange;
use crate::crates::clap::mkeymap::KeyType;
use crate::crates::clap::util::FlatSet;
use crate::crates::clap::util::Id;
use crate::crates::clap::INTERNAL_ERROR_MSG;
use crate::crates::clap::{Arg, Command};

pub fn assert_app(cmd: &Command) {
