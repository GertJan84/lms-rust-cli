use crate::crates::clap::{builder::StyledStr, ColorChoice};
...
impl Colorizer {
    pub fn new(stream: Stream, color_when: ColorChoice) -> Self {
        Colorizer {
            stream,
            color_when,
    ...
    pub fn with_content(mut self, content: StyledStr) -> Self {
