...
pub struct HelpTemplate<'cmd, 'writer> {
    writer: &'writer mut StyledStr,
    cmd: &'cmd Command,
    styles: &'cmd Styles,
    usage: &'cmd Usage<'cmd>,
...
impl<'cmd, 'writer> HelpTemplate<'cmd, 'writer> {
    ...
    pub fn write_templated_help(&mut self, template: &str) {
...
impl<'cmd, 'writer> HelpTemplate<'cmd, 'writer> {
    ...
    pub fn write_all_args(&mut self) {
...
pub fn dimensions() -> (Option<usize>, Option<usize>) {
