...
impl<'cmd> Usage<'cmd> {
    ...
    pub fn required(mut self, required: &'cmd ChildGraph<Id>) -> Self {
    ...
    pub fn create_usage_with_title(&self, used: &[Id]) -> Option<StyledStr> {
    ...
    pub fn create_usage_no_title(&self, used: &[Id]) -> Option<StyledStr> {
...
impl<'cmd> Usage<'cmd> {
    ...
    pub fn write_args(&self, styled: &mut StyledStr, incls: &[Id], force_optional: bool) {
