...
// Std
use crate::crates::clap::parser::PendingArg;
use crate::crates::clap::util::flat_map;
use crate::crates::clap::util::AnyValue;
use crate::crates::clap::util::FlatMap;
use crate::crates::clap::Arg;
use crate::crates::clap::ArgMatches;
use crate::crates::clap::Command;
use crate::crates::clap::Id;
...
impl ArgMatcher {
    ...
    pub(crate) fn args(&self) -> flat_map::Iter<'_, Id, MatchedArg> {
