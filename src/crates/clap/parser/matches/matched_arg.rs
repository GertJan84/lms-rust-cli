// Std
use crate::crates::clap::builder::ArgPredicate;
use crate::crates::clap::util::eq_ignore_case;
use crate::crates::clap::INTERNAL_ERROR_MSG;
use std::{
    ffi::{OsStr, OsString},
    iter::{Cloned, Flatten},
    slice::Iter,
...
use crate::crates::clap::util::{AnyValue, AnyValueId};
...
impl MatchedArg {
    ...
    pub fn vals(&self) -> Iter<Vec<AnyValue>> {
        self.vals.iter()
    }
    ...
    pub fn vals_flatten(&self) -> Flatten<Iter<Vec<AnyValue>>> {
    ...
    pub fn raw_vals(&self) -> Iter<Vec<OsString>> {
        self.raw_vals.iter()
    }

    pub fn raw_vals_flatten(&self) -> Flatten<Iter<Vec<OsString>>> {
    ...
    pub fn all_val_groups_empty(&self) -> bool {
